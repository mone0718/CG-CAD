class Triangle {
    ...
    void draw(int R, int G, int B) {
        ...
        W0[0]=(float)(Q0[0]/screen_x)*HALF_WIDTH;
        W0[1]=(float)(Q0[1]/screen_y)*HALF_HEIGHT; // V0
        W1[0]=(float)(Q1[0]/screen_x)*HALF_WIDTH;
        W1[1]=(float)(Q1[1]/screen_y)*HALF_HEIGHT; // V1
        W2[0]=(float)(Q2[0]/screen_x)*HALF_WIDTH;
        W2[1]=(float)(Q2[1]/screen_y)*HALF_HEIGHT; // V2
        // move to center;
        W0[0]=W0[0]+HALF_WIDTH;
        W0[1]=HALF_HEIGHT-W0[1];
        W1[0]=W1[0]+HALF_WIDTH;
        W1[1]=HALF_HEIGHT-W1[1];
        W2[0]=W2[0]+HALF_WIDTH;
        W2[1]=HALF_HEIGHT-W2[1];
        ...
        // Which is the y min value among W0[1], W1[1], and W2[1].
        int ymin = (int)W0[1];
        if (ymin>W0[1]) {
            ymin=(int)W0[1];
        }
        ...
        // Which is the y max value among W0[1], W1[1], and W2[1].
        int ymax = (int)W0[1];
        if (ymax<W0[1]) {
            ymax=(int)W0[1];
        }
        ...
        for (int iy=ymin; iy<=ymax; iy++) {
            ...
            float zt=0;
            float zs=Float.MAX_VALUE, ze=Float.MIN_VALUE;
